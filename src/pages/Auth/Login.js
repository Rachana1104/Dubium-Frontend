        ...
        <div className="content">
          ...
          <Grid item md={6} sm={12}>
            <form>
              ...
              <Button type="submit" variant="contained" className="login" style={{ width: 300 }} onClick={log_in}>
                Login
              </Button>
            </form>

            <div className="or">OR</div>
            <Button type="submit" variant="outlined" color="secondary" style={{ paddingLeft: 10, width: 300 }} className="google">
              Google
            </Button><br />
            <GoogleLogin
            ...
            <Link to="/SignUp">
              <Button type="submit" variant="outlined" color="secondary" style={{ width: 310 }} className="create">
